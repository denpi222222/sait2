...
export default function GameGuideComponent() {
  const gameFeatures = [
    ...
    },
    {
      ...
      title: "Full autonomy",
      description: "NFT collection will transition to fully decentralized market control",
      ...
      <Card className="p-6 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 border-indigo-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h4 className="text-lg font-bold text-white mb-2">Phase 1: Debugging</h4>
            <p className="text-slate-300 text-sm">
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-bold text-white mb-2">Phase 2: Autonomy</h4>
            <p className="text-slate-300 text-sm">
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-bold text-white mb-2">Phase 3: Freedom</h4>
            <p className="text-slate-300 text-sm">

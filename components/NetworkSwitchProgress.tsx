    ...
    return (
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-green-300 font-semibold">Connected to ApeChain</h3>
            <p className="text-green-200 text-sm">You're ready to use CrazyCube dApp! 🚀</p>
          </div>
        </div>
      </motion.div>
    )
      ...
      >
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-blue-300 font-semibold">Switching to ApeChain</h3>

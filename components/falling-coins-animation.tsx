...
export function FallingCoinsAnimation({ intensity = 1, className = "" }: FallingCoinsAnimationProps) {
  const [isClient, setIsClient] = useState(false)
  const [coins, setCoins] = useState<Array<{ id: number; delay: number; x: number; size: number; rotation: number }>>(
    [],
  )

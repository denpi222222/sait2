...
import { Zap, Heart, Flame, Trophy, Copy, ExternalLink, Loader2 } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="bg-slate-900/50 border-pink-500/30">
          <CardHeader className="pb-2">
            ...
            <div className="text-2xl font-bold text-pink-400">
              {breedCost ? `${parseFloat(formatEther(breedCost as bigint)).toFixed(2)} CRA` : "Loading..."}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-slate-900/50 border-green-500/30">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm text-green-300">Contract Status</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <Alert className="border-blue-500/50 bg-blue-500/10">
              ...
              <AlertDescription>
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-blue-300">Transaction Submitted</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="text-center text-slate-400">
                  {nftData ? 'NFT Data Loaded ✓' : 'Enter Token ID to query NFT data'}
                </div>
              </div>
            )}
          </CardContent>
        ...
        <Card className="bg-slate-900/50 border-pink-500/30">
          ...
          <CardContent className="space-y-4">
            ...
            <Button 
              onClick={handleBreed}
              disabled={isWritePending || isConfirming || !parent1Id || !parent2Id}

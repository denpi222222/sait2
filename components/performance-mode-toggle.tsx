...
export const PerformanceModeToggle = () => {
  const { isLiteMode, isMobile, isWeakDevice, setManualLiteMode, performanceInfo } = usePerformanceContext();
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Badge variant="secondary" className="text-xs">
                {isMobile ? <Smartphone className="w-3 h-3 mr-1" /> : <Monitor className="w-3 h-3 mr-1" />}

  ...
  const handlePing = async (tokenId: string) => {
    try {
      ...
      toast({
        ...
        description: `Ping transaction sent for NFT #${tokenId}. You'll earn CRA based on rarity!`,
      });
    } catch (error: any) {
      toast({
        title: "Ping Failed",
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <div className="text-green-300 font-bold">Earn CRA</div>
            ...
            <div>
              ...
              <div className="text-slate-400">Higher rarity = more CRA</div>
            </div>
          </div>
        </div>
      </motion.div>

    ...
    return (
      <Card className="p-6 bg-slate-800/50 backdrop-blur-sm border-slate-700">
        <div className="flex items-center justify-center h-32">
          ...
          <span className="ml-3 text-slate-300">Loading live contract data...</span>
        </div>
      </Card>
    );
  }
              ...
              <Card className="p-6 bg-gradient-to-br from-orange-900/20 to-red-900/20 border-orange-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">CRA Burned</h3>
              ...
              <Card className="p-6 bg-gradient-to-br from-yellow-900/20 to-amber-900/20 border-yellow-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">Total Stars</h3>
                      <p className="text-yellow-300 text-sm">Function disabled</p>
                    </div>
                  </div>
                </div>
              ...
              <Card className="p-6 bg-gradient-to-br from-green-900/20 to-emerald-900/20 border-green-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">Active NFTs</h3>
              ...
              <Card className="p-6 bg-gradient-to-br from-cyan-900/20 to-blue-900/20 border-cyan-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">Monthly Pool</h3>
                      <p className="text-cyan-300 text-sm">Active rewards</p>
                    </div>
                  </div>
                </div>
                <div className="text-2xl font-bold text-cyan-400">
                  {formatCRA(contractStats.currentMonthlyPool)} CRA
                </div>
              </Card>
            </motion.div>
              ...
              <Card className="p-6 bg-gradient-to-br from-purple-900/20 to-indigo-900/20 border-purple-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">Locked Pool</h3>
                      <p className="text-purple-300 text-sm">Reserved funds</p>
                    </div>
                  </div>
                </div>
                <div className="text-2xl font-bold text-purple-400">
                  {formatCRA(contractStats.currentLockedPool)} CRA
                </div>
              </Card>
            </motion.div>
              ...
              <Card className="p-6 bg-gradient-to-br from-emerald-900/20 to-green-900/20 border-emerald-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">Main Treasury</h3>
                      <p className="text-emerald-300 text-sm">Contract balance</p>
                    </div>
                  </div>
                </div>
                <div className="text-2xl font-bold text-emerald-400">
                  {formatCRA(contractStats.mainTreasury)} CRA
                </div>
              </Card>
            </motion.div>
          </div>
              ...
              <Card className="p-6 bg-gradient-to-br from-blue-900/20 to-indigo-900/20 border-blue-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">Ping Interval</h3>
                      <p className="text-blue-300 text-sm">Current setting</p>
                    </div>
                  </div>
                </div>
                <div className="text-xl font-bold text-blue-400">
                  {Math.floor(parseInt(contractStats.pingInterval) / 3600)}h {Math.floor((parseInt(contractStats.pingInterval) % 3600) / 60)}m
                </div>
              </Card>
            </motion.div>
              ...
              <Card className="p-6 bg-gradient-to-br from-pink-900/20 to-rose-900/20 border-pink-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">Breed Cost</h3>
                      <p className="text-pink-300 text-sm">Current price</p>
                    </div>
                  </div>
                </div>
                <div className="text-xl font-bold text-pink-400">
                  {formatWithCommas(parseFloat(contractStats.currentBreedCost).toFixed(2))} CRA
                </div>
              </Card>
            </motion.div>
              ...
              <Card className="p-6 bg-gradient-to-br from-amber-900/20 to-yellow-900/20 border-amber-500/30">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white">Dynamic Rate</h3>
                      <p className="text-amber-300 text-sm">Rewards per second</p>
                    </div>
                  </div>
                </div>
                <div className="text-xl font-bold text-amber-400">
                  {parseFloat(contractStats.rewardRatePerSecond).toFixed(0)} CRA/s
                </div>
              </Card>
            </motion.div>
          </div>

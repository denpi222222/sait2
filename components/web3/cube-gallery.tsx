...
const getRarityColor = (rarity: number) => {
  switch (rarity) {
    case 6: return "text-purple-400 border-purple-400"
    case 5: return "text-orange-400 border-orange-400"
            ...
            <Card className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border-cyan-500/30 backdrop-blur-sm overflow-hidden relative group">
              <CardContent className="p-6">
                ...
                <div className="relative mb-4">
                  <motion.div
                    animate={hoveredCube === cube.id ? {
                      rotateY: [0, 360],
                      scale: [1, 1.1, 1]
                    } : {}}
                    transition={{ duration: 2, repeat: hoveredCube === cube.id ? Infinity : 0 }}
                  ...
                  >
                    <div className="bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full p-2 shadow-lg shadow-cyan-500/50">
                      <span className="text-white font-bold text-sm">{cube.power}</span>
                    </div>
                  </motion.div>
                </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-white">{selectedCube.power}</span>
                  </div>
                </div>

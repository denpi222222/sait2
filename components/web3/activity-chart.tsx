...
export function ActivityChart() {
  ...
  return (
    <ChartCard title="NFT Activity" icon={<Activity className="h-5 w-5" />} color="blue" loading={isLoading}>
      {/* Tabs */}
      ...
      <div className="flex justify-center mt-3 space-x-4 text-xs text-slate-300">
        <div className="flex items-center"><span className="w-3 h-3 bg-violet-500 mr-1"></span>Pings</div>
        <div className="flex items-center"><span className="w-3 h-3 bg-orange-500 mr-1"></span>Burns</div>
        <div className="flex items-center"><span className="w-3 h-3 bg-blue-500 mr-1"></span>Breeds</div>
      </div>
    </ChartCard>
  )
}

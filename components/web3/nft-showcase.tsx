    ...
    <div className="w-full max-w-6xl mx-auto p-6 space-y-12">
      ...
      >
        ...
        <p className="text-xl text-cyan-200 max-w-2xl mx-auto">
          Trade unique NFT cubes, collect rare artifacts, and dominate the metaverse!
        </p>
      </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h4 className="text-lg font-semibold text-cyan-300 mb-3">Attributes:</h4>
                  <StatBar label="Attack" value={currentNFT.stats.attack} icon={Sword} />
                  <StatBar label="Defense" value={currentNFT.stats.defense} icon={Shield} />
                  <StatBar label="Speed" value={currentNFT.stats.speed} icon={Zap} />
                  <StatBar label="Magic" value={currentNFT.stats.magic} icon={Sparkles} />
                </div>
          ...
          >
            ...
            >
              <div className="text-center space-y-6">
                ...
                <div>
                  <Badge className={`mb-3 bg-gradient-to-r ${getRarityColor(selectedNFT.rarity)}`}>
                    {selectedNFT.rarity}
                  </Badge>
                  <h2 className="text-3xl font-bold text-white mb-2">{selectedNFT.name}</h2>
                  <p className="text-xl text-yellow-400 font-bold">{selectedNFT.price}</p>
                </div>

                <div className="space-y-3 text-left">
                  <StatBar label="Attack" value={selectedNFT.stats.attack} icon={Sword} />
                  <StatBar label="Defense" value={selectedNFT.stats.defense} icon={Shield} />
                  <StatBar label="Speed" value={selectedNFT.stats.speed} icon={Zap} />
                  <StatBar label="Magic" value={selectedNFT.stats.magic} icon={Sparkles} />
                </div>

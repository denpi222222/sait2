  ...
  const gameFeatures = [
    {
      ...
      description: "Your CRA tokens are locked and accumulated, not burned forever!",
      color: "from-amber-500 to-orange-500"
    },
    {
      icon: <Shield className="h-6 w-6 text-blue-400" />,
      title: "Decentralized future",
      description: "After debugging (1-2 months) the team will disable admin rights and transfer control to an autonomous agent",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: <Lock className="h-6 w-6 text-green-400" />,
      title: "Full autonomy",
      description: "NFT collection will transfer to fully decentralized management market",
        ...
        <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-600/30">
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <span className="text-white">Burned for 24 hours, CRA tokens are locked and accumulated</span>
            </div>
            <div className="flex items-center">
              <Badge className="bg-purple-600 mr-3">NFT #3</Badge>
              <span className="text-white">In graveyard, ready to breed through 48 hours</span>
            </div>
          </div>
          
          <div className="mt-6 p-4 bg-green-900/20 rounded-lg border border-green-500/30">
            <p className="text-green-300 font-semibold">
              💡 Result: Constant stream of CRA tokens without losses!
            </p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 border-indigo-500/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-300 text-sm">
              {t('info.roadmap.phase3.desc', 'Fully decentralized management only by market')}
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-indigo-900/20 rounded-lg border border-indigo-500/30">
          <p className="text-indigo-300 text-center font-semibold">
            {t('info.roadmap.tagline', '🚀 CrazyCube - first NFT collection with full decentralization plan!')}
          </p>
        </div>
      </Card>
    </div>

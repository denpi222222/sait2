    ...
    <div className={`relative ${className}`}>
      ...
      >
        ...
        {Array.from({ length: 10 }).map((_, i) => {
          ...
          const colorClass = gemColors[Math.floor(Math.random() * gemColors.length)]
          ...
          return (
            ...
            >
              <div className={`w-6 h-6 bg-gradient-to-br ${colorClass} rounded-md transform rotate-45 shadow-lg`}>

...
const CUBE_IMAGES = ["/images/d1.png", "/images/d2.png", "/images/d3.png", "/images/d4.png", "/images/d5.png"] as const;
      ...
      {CUBE_IMAGES.map((src, idx) => (
        ...
        >
          ...
          {bubbleIdx === idx && (
            ...
            >
              {BUBBLES.length > 0 ? BUBBLES[Math.floor(Math.random() * BUBBLES.length)] : "Don't look!"}
            </motion.div>
          )}
        </motion.div>
      ))}

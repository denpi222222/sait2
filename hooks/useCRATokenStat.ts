...
export const useCRATokenStat = () => {
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        setLoading(true);
        const query = `query TokenStat { tokenStat(id: \"cra\") { totalSupply burned circulating treasury dexLiquidity airdrop rewards priceUsd marketCapUsd volume24hUsd } }`;
        ...
        console.error("useCRATokenStat", e);

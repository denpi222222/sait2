...
export const useContractStats = () => {
  ...
  const fetchContractStats = async () => {
    ...
    try {
      setError(null)
      console.log('🔄 Fetching contract stats directly...')
      ...
      const [
        ...
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'totalBurnedCRA' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'totalBurned' }),
        // publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'totalStars' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'monthlyRewardPool' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'totalLockedForRewards' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'mainTreasury' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'getBreedCostCRA' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'rewardRatePerSecond' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'pingInterval' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'breedCooldown' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'graveyardCooldown' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'burnFeeBps' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'manualFloorPrice' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'monthlyUnlockPercentage' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'totalBurned' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'perPingCapDivisor' }),
        publicClient.readContract({ address: GAME_ADDR, abi: CONTRACT_ABI, functionName: 'paused' })
      ])
      ...
      console.log('✅ Contract stats loaded:', {
        ...
        currentMonthlyPool: contractStats.currentMonthlyPool,
        totalStars: contractStats.totalStars,

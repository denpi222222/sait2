    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-900 to-green-900 p-4">
      ...
      <div className="container mx-auto">
        <header className="mb-8 flex items-center">
          <Link href="/">
            <Button variant="outline" className="border-green-500/30 bg-black/20 text-green-300 hover:bg-black/40">
        ...
        <p className="text-center text-green-300 mt-2">Collect your well-earned CRA rewards! 🎉</p>

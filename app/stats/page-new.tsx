    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-purple-900 p-4">
      ...
      <div className="container mx-auto">
        <header className="mb-8 flex items-center">
          <Link href="/">
            <Button variant="outline" className="border-purple-500/30 bg-black/20 text-purple-300 hover:bg-black/40">
        ...
        <p className="text-center text-purple-300 mt-2">Track the chaos and see who's winning the cube game!</p>
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="mt-8">
          <TabsList className="mb-4">
            <TabsTrigger value="overview">{t("stats.tabs.overview", "Overview")}</TabsTrigger>
            <TabsTrigger value="subgraph">{t("stats.tabs.subgraph", "Subgraph Data")}</TabsTrigger>
            <TabsTrigger value="charts">{t("stats.tabs.charts", "Charts")}</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="subgraph">
            <div className="grid grid-cols-1 gap-6">
              ...
              <Card className="p-4">
                ...
                <p className="text-sm text-gray-600 mt-2">{t("stats.subgraph.aboutParagraph2", "This lets us quickly retrieve info about any NFT and its history without rescanning the whole blockchain each time.")}</p>
              </Card>
            </div>
          </TabsContent>
